...
//  I got an undefined value.
// 2. What is "this" when joe.scopeArrow() is invoked?
//  I got a Window.
// 3. Explain why "this" is different when an arrow function is used.
//  this is scoped to whatever it is currently in referance to. the first this is in refrence to that function while the second one is in reference to the the student object joe.
